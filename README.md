...
./vendor/bin/codecept run unit models/UsersTest
```
Unit tests are located in tests/unit directory.

Tests are configured in tests/unit.suite.yml

By accessing $this->tester class inside a test case you can use methods of Yii2 module. So if you have orm and email parts enables so you can call methods belonging from these parts:
```
...
To create  a new "ExampleTest" file located in the tests/unit directory

php vendor/bin/codecept generate:test unit Example

To run:

php vendor/bin/codecpt run unit ExampleTest
